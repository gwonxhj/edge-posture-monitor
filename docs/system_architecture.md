# Edge AI Posture Monitoring System Architecture
...
src/
 ├ app_flow
 │   ├ app_flow_controller.py
 │   ├ calibration_flow.py
 │   └ sit_detector.py
 ├ communication
 │   ├ app_command_handler.py
...
Posture Score Engine
   │
   ▼
Report Generator / LLM Report Engine
   │
   ▼
DatabaseManager
```
